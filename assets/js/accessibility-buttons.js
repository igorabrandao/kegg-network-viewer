...
var accessibilityButtons = function accessibilityButtons(options) {
  ...
  var setting = {
    font: {
      nameButtonIncrease: '<i class="fa fa-plus"></i><i class="fa fa-font"></i>',
      ariaLabelButtonIncrease: 'Increase Font',
      nameButtonDecrease: '<i class="fa fa-minus"></i><i class="fa fa-font"></i>',
      ariaLabelButtonDecrease: 'Decrease Font'
    },
    contrast: {
      nameButtonAdd: '<i class="fa fa-plus"></i><i class="fa fa-adjust"></i>',
      ariaLabelButtonAdd: 'Add Contrast',
      nameButtonRemove: '<i class="fa fa-minus"></i><i class="fa fa-adjust"></i>',
