...
function createOnlineVisitorsCounterElement()
{
    ...
    if (existingElement === null) // Only creates a new element if does not exist yet.
    {
        ...
        button.style.cssText = 'z-index:999; position: fixed; bottom: 5px; right: ' + (screen.width/2) + 'px; background-color:transparent; -moz-border-radius:28px; -webkit-border-radius:28px; border-radius:28px; border:2px solid #8dc0e3; display:inline-block; cursor:pointer; color:#178F89; font-family:Trebuchet MS; font-size:15px; padding:9px 15px; text-decoration:none;';
